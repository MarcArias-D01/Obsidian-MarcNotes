...
Muestra información de los monitores que tienes conectado en tu linux. Has de tener instalafo hyprlnad como entorno gráfico del sistema
```bahs
hyprctl monitors
```
### *Imagen de ejemplo*
![[linux-hyprctl-monitors.png]]
